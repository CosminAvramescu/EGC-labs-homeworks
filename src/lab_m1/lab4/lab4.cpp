...
void Lab4::RenderScene(float deltaTimeSeconds) {
    ...
    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(-5.0f, 2, -2);
    ...
    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(-5.0f, 2, -2);
    modelMatrix *= transform3D::RotateOX(angularStep * 1.2);
    modelMatrix *= transform3D::Translate(0, 4, 2);
    RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);


    modelMatrix *= transform3D::RotateOX(angularStep * 5);
    modelMatrix *= transform3D::Translate(0, 2, 0);
    RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
}
